...
// export function
export default function AddToDoForm({academicCourseId, isOpen, onClose}: addToDoFormProps){
        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent>
                ...
                <form className={styles.toDoForm} onSubmit={(e) => e.preventDefault()}>
                    ...
                    {/* Save Button */}
                    <button type="button" className={styles.handler} onClick={validateSave}>Create</button>
