...
// database import
import { getToDos, getToDosByFilter, getToDosById } from "@/features/calendar/apis/todo.api";
...
export const CalendarComp = ({
  ...
  const FormattedEventsInput: EventInput[] = events.map((todo: any) => ({
    ...
    useEffect(() => {
      ...
      return (
        <div
          className={'flex px-10 justify-start items-start gap-8' + " " + styles.container}
        >
          <div
            className={'w-3/12' + ' ' + styles.divListContainer}
          >
